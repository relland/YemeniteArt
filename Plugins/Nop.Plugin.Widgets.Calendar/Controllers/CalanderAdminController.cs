...
namespace Nop.Plugin.Widgets.Calendar.Controllers
{
    public class CalanderAdminController : BaseAdminController
    {
        ...
        //[NonAction]
        //private void PrepareOpenEventsListModel(OpenEventsListModel model, List<OpenEvent> openEvents)
        //{
        //    if (openEvents != null)
        //    {
        ...
        //            };
        //            oem.Events = PrepareEventsModel(openEvent.AppliedEvents);
        //            //model. .OpenEvents.Add(oem);
        //        }
        //    }
        ...
        public ActionResult AddSessions(SessionCreationModal model)
        {
            ...
            {
                model.SuHours.AddSessions(model.From, model.To);
            }
        ...
        {
            var evnt = _calanderService.GetEventById(id);
            if (evnt == null)
                return RedirectToAction("List");
        ...
        {
            var evnt = _calanderService.GetEventById(model.Id);
            var openEvent = _calanderService.GetOpenEventById(model.OpenEventId);
