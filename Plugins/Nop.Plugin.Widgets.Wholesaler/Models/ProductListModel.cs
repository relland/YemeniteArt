...
namespace Nop.Plugin.Widgets.Wholesaler.Models
{
    public partial class ProductListModel : BaseNopModel
    {
        public ProductListModel()
        {
            ...
            //rel
            AvailableVisibleIndividuallyOnlyOptions = new List<SelectListItem>();
        }
        ...
        //rel
        [NopResourceDisplayName("ya.VisibleIndividually")]
        public int VisibleIndividuallyOnly { get; set; }
        ...
        //rel
        public IList<SelectListItem> AvailableVisibleIndividuallyOnlyOptions { get; set; }
    }
}
