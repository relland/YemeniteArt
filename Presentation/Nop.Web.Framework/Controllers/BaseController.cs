    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual string RenderPartialViewToString(string viewName, object model)
        {
            ...
            using (var sw = new StringWriter())
            {
                ...
                //{"e:\\GoogleDrive1\\nopCommerce_ya\\nopCommerce_3.80_Source\\Presentation\\Nop.Web\\Plugins\\BrainStation.QuickView\\Views\\
                //QuickViewProductTemplate.Simple.cshtml(9): 
                //error CS1061: 'System.Web.Mvc.HtmlHelper<Nop.Web.Models.Catalog.ProductDetailsModel>' does not contain a definition for 'AddTitleParts' 
                //and no extension method 'AddTitleParts' accepting a first argument of type 'System.Web.Mvc.HtmlHelper<Nop.Web.Models.Catalog.
                //ProductDetailsModel >' could be found (are you missing a using directive or an assembly reference?)"}

                //{"e:\\GoogleDrive1\\nopCommerce_ya\\nopCommerce_3.80_Source\\Presentation\\Nop.Web\\Plugins\\BrainStation.QuickView\\Views\\
                //QuickViewProductTemplate.Simple.cshtml(9): error CS1061: 'System.Web.Mvc.HtmlHelper<Nop.Web.Models.Catalog.ProductDetailsModel>' 
                //does not contain a definition for 'AddTitleParts' and no extension method 'AddTitleParts' accepting a first argument of type 
                //'System.Web.Mvc.HtmlHelper<Nop.Web.Models.Catalog.ProductDetailsModel>' could be found 
        ...
        protected virtual void ErrorNotification_REL(Exception exception, string err, bool persistForTheNextRequest = true, bool logException = true)
        {
            if (logException)
                LogException(exception);
            AddNotification(NotifyType.Error, err + "_original:_" + exception.Message, persistForTheNextRequest);
        }
        /// <summary>
