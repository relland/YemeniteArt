    ...
    public partial class SettingController : BaseAdminController
	{
        ...
        public ActionResult Media()
        {
            ...
            if (storeScope > 0)
            {
                ...
                //rel
                model.CategoryThumbPictureBSize_OverrideForStore = _settingService.SettingExists(mediaSettings, x => x.CategoryThumbPictureBSize, storeScope);
        ...
        public ActionResult Media(MediaSettingsModel model)
        {
            ...
            //rel
            _settingService.SaveSettingOverridablePerStore(mediaSettings, x => x.CategoryThumbPictureBSize, model.CategoryThumbPictureBSize_OverrideForStore, storeScope, false);
