    ...
    public partial class ProductAttributeController : BaseAdminController
    {
        ...
        public ActionResult PredefinedProductAttributeValueEditPopup(int id)
        {
            ...
            var model = new PredefinedProductAttributeValueModel
            {
                ...
                ImageSquaresPictureId = ppav.ImageSquaresPictureId,
                //IsStoneProductAttributeValue = ppav.IsStoneProductAttributeValue,
                StoneProductAttributeValueId = ppav.StoneProductAttributeValueId,
                SKUCode = ppav.SKUCode,
                StoneNameId = ppav.StoneNameId,
                ImageSquaresPictureIdUrl = pictureService.GetPictureUrl(ppav.ImageSquaresPictureId, 75, false)
        };
            //locales
            AddLocales(_languageService, model.Locales, (locale, languageId) =>
            {
        ...
        public ActionResult PredefinedProductAttributeValueEditPopup(string btnId, string formId, PredefinedProductAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ppav.ImageSquaresPictureId = model.ImageSquaresPictureId;
                //ppav.IsStoneProductAttributeValue = model.IsStoneProductAttributeValue;
                ppav.SKUCode = model.SKUCode;
                ppav.StoneNameId = model.StoneNameId;
                ppav.StoneProductAttributeValueId = model.StoneProductAttributeValueId;
