...
namespace Nop.Admin.Controllers
{
    public partial class ProductController : BaseAdminController
    {
        ...
        public ActionResult ProductList(DataSourceRequest command, ProductListModel model)
        {
            ...
            //rel
            bool? visibleIndividuallyOnly = null;
            if (model.VisibleIndividuallyOnly == 1)
                visibleIndividuallyOnly = false;
            else if (model.VisibleIndividuallyOnly == 2)
            ...
            var products = _productService.SearchProducts(
                ...
                //rel
                visibleIndividuallyOnly: visibleIndividuallyOnly.HasValue ? visibleIndividuallyOnly.Value : false
            );
        ...
        [HttpPost, ActionName("List")]
        [FormValueRequired("rel-exportexcel-all")]
        public ActionResult REL_ExportExcelAll(ProductListModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
                return AccessDeniedView();
            ...
            try
            {
                var bytes = _exportManager.REL_ExportProductsToXlsx(products);
        ...
        //rel
        [HttpPost]
        public ActionResult REL_ExportExcelSelected(string selectedIds)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
                return AccessDeniedView();
        ...
        //rel
        [HttpPost]
        public ActionResult REL_ImportExcel()
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
                return AccessDeniedView();
            ...
            try
            {
                var file = Request.Files["rel-importexcelfile"];
                var basePath = Request.Form["rel-base-image-folder-path"];
                if (file != null && file.ContentLength > 0)
                {
                    _importManager.REL_ImportProductsFromXlsx(file.InputStream, basePath);
                }
                else
                {
                    ErrorNotification(_localizationService.GetResource("Admin.Common.UploadFile"));
        ...
        [HttpPost]
        public ActionResult REL_ImportExcel_Test()
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
                return AccessDeniedView();
            ...
            try
            {
                var file = Request.Files["rel-importexcelfile-test"];
                var basePath = Request.Form["rel-base-image-folder-path-test"];
                if (file != null && file.ContentLength > 0)
                {
                    _importManager.REL_ImportProductsFromXlsx_Test(file.InputStream, basePath, out errorMessage);
                }
                else
                {
                    ErrorNotification(_localizationService.GetResource("Admin.Common.UploadFile"));
            ...
            {
                ErrorNotification_REL(exc, errorMessage);
                return RedirectToAction("List");
            }
            ...
            var attributesModel = attributes
                .Select(x =>
                {
                    var attributeModel = new ProductModel.ProductAttributeMappingModel
                    {
                        ...
                        DisplayOrder = x.DisplayOrder,
                        IsStoneAttribute = x.IsStoneAttribute
                    };
        ...
        public ActionResult ProductAttributeMappingInsert(ProductModel.ProductAttributeMappingModel model)
        {
            ...
            var productAttributeMapping = new ProductAttributeMapping
            {
                ...
                IsStoneAttribute = model.IsStoneAttribute
            };
            ...
            foreach (var predefinedValue in predefinedValues)
            {
                var pav = new ProductAttributeValue
                {
                    ...
                    SKUCode = predefinedValue.SKUCode,
                    //IsStoneProductAttributeValue = predefinedValue.IsStoneProductAttributeValue,
                    StoneNameId = predefinedValue.StoneNameId,
                    StoneProductAttributeValueId = predefinedValue.StoneProductAttributeValueId,
                    ZIndex = predefinedValue.ZIndex
                };
        ...
        public ActionResult ProductAttributeMappingUpdate(ProductModel.ProductAttributeMappingModel model)
        {
            ...
            productAttributeMapping.IsStoneAttribute = model.IsStoneAttribute;
            ...
            var gridModel = new DataSourceResult
            {
                Data = values.Select(x =>
                {
                    ...
                    return new ProductModel.ProductAttributeValueModel
                    {
                        ...
                        AssociatedProductName = associatedProduct != null 
                            ? !string.IsNullOrWhiteSpace(associatedProduct.Sku) 
                                ? string.Format("{0} (sku: {1})", associatedProduct.Name, associatedProduct.Sku) 
                                : associatedProduct.Name 
                            : "",
                        Name = x.ProductAttributeMapping.AttributeControlType != AttributeControlType.ColorSquares 
                            ? x.Name
                            : string.Format("{0} - {1}", x.Name, x.ColorSquaresRgb),
                        ...
                        SKUCode = x.SKUCode,
                        //IsStoneProductAttributeValue = x.IsStoneProductAttributeValue,
                        StoneProductAttributeValueId = x.StoneProductAttributeValueId,
                        StoneNameId = x.StoneNameId,
                        ZIndex = x.ZIndex
                    };
                }),
                Total = values.Count()
        ...
        public ActionResult ProductAttributeValueCreatePopup(string btnId, string formId, ProductModel.ProductAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var pav = new ProductAttributeValue
                {
                    ...
                    StoneNameId = model.StoneNameId,
                    //IsStoneProductAttributeValue = model.IsStoneProductAttributeValue,
                    SKUCode = model.SKUCode,
                    StoneProductAttributeValueId = model.StoneProductAttributeValueId,
                    ZIndex = model.ZIndex
                };
            ...
            //rel
            model.AssociatedProductSku = associatedProduct != null ? associatedProduct.Sku : "";
        ...
        public ActionResult ProductAttributeValueEditPopup(int id)
        {
            ...
            var model = new ProductModel.ProductAttributeValueModel
            {
                ...
                //rel
                AssociatedProductSku = associatedProduct != null ? associatedProduct.Sku : "",
                Name = pav.Name,
                ...
                SKUCode = pav.SKUCode,
                StoneProductAttributeValueId = pav.StoneProductAttributeValueId,
        ...
        public ActionResult ProductAttributeValueEditPopup(string btnId, string formId, ProductModel.ProductAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                pav.SKUCode = model.SKUCode;
                //pav.IsStoneProductAttributeValue = model.IsStoneProductAttributeValue;
                pav.StoneNameId = model.StoneNameId;
                pav.StoneProductAttributeValueId = model.StoneProductAttributeValueId;
                pav.ZIndex = model.ZIndex;           
            ...
            ProductModel.ProductAttributeValueModel.AssociateProductToAttributeValueModel model)
        {
            ...
            var products = _productService.SearchProducts(
                ...
                vendorId: model.SearchVendorId,
                productType: model.SearchProductTypeId > 0 ? (ProductType?)model.SearchProductTypeId : null,
                keywords: !string.IsNullOrWhiteSpace(model.SearchProductSku) ? model.SearchProductSku : model.SearchProductName,
                searchSku: !string.IsNullOrWhiteSpace(model.SearchProductSku),
                pageIndex: command.Page - 1,
                pageSize: command.PageSize,
                showHidden: true
                );
            ...
            string productNameInput, ProductModel.ProductAttributeValueModel.AssociateProductToAttributeValueModel model)
        {
            ...
            //rel
            ViewBag.productSku = string.Format("(sku: {0})", associatedProduct.Sku);
            return View(model);
        }
        //http://localhost:15536/Admin/Product/AssociateProductToAttributeValuePopup?productIdInput=AssociatedProductId&productNameInput=associate-product-name
