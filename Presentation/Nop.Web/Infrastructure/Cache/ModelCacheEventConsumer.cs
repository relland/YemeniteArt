...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string CATEGORY_PICTURE_B_MODEL_KEY = "Nop.pres.category.pictureb-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CATEGORY_PICTURE_B_PATTERN_KEY = "Nop.pres.category.pictureb";
