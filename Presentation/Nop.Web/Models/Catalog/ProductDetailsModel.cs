...
namespace Nop.Web.Models.Catalog
{
    public partial class ProductDetailsModel : BaseNopEntityModel
    {
        public ProductDetailsModel()
        {
            ...
            //rel
            ComparisonPictureModel = new PictureModel();
            SilverGF14K18KSeNames = new List<string>();
            //end rel
        ...
        //rel
        public PictureModel ComparisonPictureModel { get; set; }
        public bool DisplaySilverGF14K18K { get; set; }
        public List<string> SilverGF14K18KSeNames { get; set; }
