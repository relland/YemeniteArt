...
namespace Nop.Web.Controllers
{
    public partial class ProductController : BasePublicController
    {
        ...
        ////rel
        //[NonAction]
        //protected virtual ProductDetailsModel RELSilverAndGoldPrepareProductDetailsPageModelAndUpdateAttributes(Product product, string attributesXml,
        //    ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        //{
        //    if (product == null)
        //        throw new ArgumentNullException("product");
        ...
        //            AttributeControlType = attribute.AttributeControlType,
        //            //rel
        //            DefaultValue = null,//updatecartitem != null ? null : attribute.DefaultValue,
        //            HasCondition = !String.IsNullOrEmpty(attribute.ConditionAttributeXml),
        //            IsStoneAttribute = attribute.IsStoneAttribute
        //        };
        //        if (!String.IsNullOrEmpty(attribute.ValidationFileAllowedExtensions))
        ...
        //        //set already selected attributes (if we're going to update the existing shopping cart item)
        //        if (!string.IsNullOrWhiteSpace(attributesXml))//(updatecartitem != null)
        //        {
        //            switch (attribute.AttributeControlType)
        //            {
        //                case AttributeControlType.DropdownList:
        ...
        //                            //select new values
        //                            var selectedValues = _productAttributeParser.ParseProductAttributeValues(attributesXml);
        //                            foreach (var attributeValue in selectedValues)
        //                                foreach (var item in attributeModel.Values)
        //                                    if (attributeValue.Id == item.Id)
        //                                        item.IsPreSelected = true;
        ...
        ////rel
        //[NopHttpsRequirement(SslRequirement.No)]
        //public ActionResult RELSilverAndGoldProductDetails(int productId, FormCollection form, int updatecartitemid = 0)
        //{
        //    var product = _productService.GetProductById(productId);
        //    if (product == null || product.Deleted)
        //        return InvokeHttp404();
