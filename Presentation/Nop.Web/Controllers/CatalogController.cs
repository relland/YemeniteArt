...
namespace Nop.Web.Controllers
{
    public partial class CatalogController : BasePublicController
    {
        ...
        public ActionResult GalleryShop()
        {
            var allCategories = _categoryService.GetAllCategoriesByParentCategoryId(0);
            var allModels = new List<CategoryModel>();
            foreach (var category in allCategories)
            {
                ...
                var pictureBSize = _mediaSettings.CategoryThumbPictureBSize;
                ...
                model.SubCategories = _cacheManager.Get(subCategoriesCacheKey, () =>
                    ...
                    var categoryPictureCacheKey = string.Format(ModelCacheEventConsumer.CATEGORY_PICTURE_MODEL_KEY, x.Id, pictureSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
                        ...
                        //rel
                        var categoryPictureBCacheKey = string.Format(ModelCacheEventConsumer.CATEGORY_PICTURE_B_MODEL_KEY, x.Id, pictureSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
                        subCatModel.PictureBModel = _cacheManager.Get(categoryPictureBCacheKey, () =>
                        {
                            var pictureB = _pictureService.GetPictureById(x.PictureBId);
                            var pictureBModel = new PictureModel
                            {
                                FullSizeImageUrl = _pictureService.GetPictureUrl(pictureB),
                                ImageUrl = _pictureService.GetPictureUrl(pictureB, pictureSize),
                                Title = string.Format(_localizationService.GetResource("Media.Category.ImageLinkTitleFormat"), subCatModel.Name),
                                AlternateText = string.Format(_localizationService.GetResource("Media.Category.ImageAlternateTextFormat"), subCatModel.Name)
                            };
                            return pictureBModel;
                        });
            ...
            //activity log
            _customerActivityService.InsertActivity("PublicStore.ViewCategory", _localizationService.GetResource("ActivityLog.PublicStore.ViewCategory"), "AllCategories");
        ...
        public ActionResult Category(int categoryId, CatalogPagingFilteringModel command)
        {
            ...
            model.SubCategories = _cacheManager.Get(subCategoriesCacheKey, () =>
                ...
                .Select(x =>
                {
                    ...
                    ////REL
                    //var categoryPictureBCacheKey = string.Format(ModelCacheEventConsumer.CATEGORY_PICTURE_B_MODEL_KEY, x.Id, pictureBSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
                    //subCatModel.PictureBModel = _cacheManager.Get(categoryPictureBCacheKey, () =>
                    //{
                    //    var pictureB = _pictureService.GetPictureById(x.PictureBId);
                    //    var pictureBModel = new PictureModel
                    //    {
                    //        FullSizeImageUrl = _pictureService.GetPictureUrl(pictureB),
                    //        ImageUrl = _pictureService.GetPictureUrl(pictureB, pictureBSize),
                    //        Title = string.Format(_localizationService.GetResource("Media.Category.ImageLinkTitleFormat"), subCatModel.Name),
                    //        AlternateText = string.Format(_localizationService.GetResource("Media.Category.ImageAlternateTextFormat"), subCatModel.Name)
                    //    };
                    //    return pictureBModel;
            ...
            //REL - pictureB
            var categoryPictureBCacheKey = string.Format(ModelCacheEventConsumer.CATEGORY_PICTURE_B_MODEL_KEY, category.Id, pictureBSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
            model.PictureBModel = _cacheManager.Get(categoryPictureBCacheKey, () =>
            {
                var pictureB = _pictureService.GetPictureById(category.PictureBId);
                var pictureBModel = new PictureModel
                {
                    FullSizeImageUrl = _pictureService.GetPictureUrl(pictureB),
                    ImageUrl = _pictureService.GetPictureUrl(pictureB, pictureBSize),
        ...
        public ActionResult HomepageCategories()
        {
            ...
            var model = _cacheManager.Get(categoriesCacheKey, () =>
                ...
                .Select(x =>
                {
                    ...
                    //REL
                    var categoryPictureBCacheKey = string.Format(ModelCacheEventConsumer.CATEGORY_PICTURE_B_MODEL_KEY, x.Id, pictureBSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
                    catModel.PictureBModel = _cacheManager.Get(categoryPictureBCacheKey, () =>
                    {
                        var pictureB = _pictureService.GetPictureById(x.PictureBId);
                        var pictureBModel = new PictureModel
                        {
