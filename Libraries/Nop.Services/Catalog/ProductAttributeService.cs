...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        /// </summary>
        /// <param name="productAttributeMappingId">Product attribute Mapping identifier</param>
        /// <param name="productAttributeValueSKUCode">Product attribute value SKUCode</param>
        /// <returns>Product attribute value</returns>
        public virtual ProductAttributeValue GetProductAttributeValueByProductAttributeMappingIdAndAttributeValueSKUCode(int productAttributeMappingId, string productAttributeValueSKUCode)
        {
            if (string.IsNullOrWhiteSpace(productAttributeValueSKUCode) || productAttributeMappingId == 0)
                return null;

            //string key = string.Format(PRODUCTATTRIBUTEVALUES_BY_ID_KEY, productAttributeValueId);
            //return _cacheManager.Get(key, () => _productAttributeValueRepository.GetById(productAttributeValueId));
            return _productAttributeValueRepository.Table.FirstOrDefault(x => x.ProductAttributeMappingId == productAttributeMappingId && x.SKUCode == productAttributeValueSKUCode);
        }
        //end rel
