...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductAttributeService
    {
        ...
        /// <returns>Product attribute value</returns>
        ProductAttributeValue GetProductAttributeValueByProductAttributeMappingIdAndAttributeValueSKUCode(int productAttributeMappingId, string productAttributeValueSKUCode);
