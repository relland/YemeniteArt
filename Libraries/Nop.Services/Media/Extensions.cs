...
namespace Nop.Services.Media
{
    ...
    public static class Extensions
    {
        ...
        /// <param name="productAttributeParser">Product attribute service</param>
        /// <returns>Picture</returns>
        public static Picture GetProductPictureIgnoreAttribute(this Product product, IPictureService pictureService)
        {
            if (product == null)
                throw new ArgumentNullException("product");
            if (pictureService == null)
            ...
            Picture picture = pictureService.GetPicturesByProductId(product.Id, 1).FirstOrDefault();
