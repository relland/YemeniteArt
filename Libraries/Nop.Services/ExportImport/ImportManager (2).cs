    ...
    public partial class ImportManager : IImportManager
    {
        ...
        private void AddConditions(List<Conditions> conditionsList)
        {
            foreach (var condition in conditionsList.Where(x => x.HasCondition))
            {
                ...
                var value = condition.RowValueIsSelected ? valueId != null ? valueId.ToString() : "" : ""; 
                var productAttributeMapping = _productAttributeService.GetProductAttributeMappingById(condition.ProductAttributeMappingId);
                string attributesXml = _productAttributeParser.AddProductAttribute(productAttributeMapping.ConditionAttributeXml, productAttributeMapping, value);
                ...
                var attributProperties = new[]
                   {
                        ...
                        new PropertyByName<ExportProductAttribute>("HasCondition"),//rel
                        new PropertyByName<ExportProductAttribute>("RowValueIdForCondition"),//rel
                        new PropertyByName<ExportProductAttribute>("RowValueIsSelected"),//rel
                        new PropertyByName<ExportProductAttribute>("RowValueId"),//rel
                        new PropertyByName<ExportProductAttribute>("AttributeTextPrompt"),
                        new PropertyByName<ExportProductAttribute>("IsStoneAttribute"),//rel
                        ...
                        new PropertyByName<ExportProductAttribute>("IsStoneProductAttributeValue"),//rel
                        new PropertyByName<ExportProductAttribute>("Zindex"),//rel
                        new PropertyByName<ExportProductAttribute>("SKUCode"),//rel
                        new PropertyByName<ExportProductAttribute>("StoneNameId"),//rel
                        new PropertyByName<ExportProductAttribute>("PictureId"),
                        new PropertyByName<ExportProductAttribute>("BigPicture"),//rel
                        new PropertyByName<ExportProductAttribute>("SmallPicture")//rel
                    };
                ...
                for (var iRow = 2; iRow < endRow; iRow++)
                {
                    ...
                    if (worksheet.Row(iRow).OutlineLevel != 0)
                    {
                        if (_catalogSettings.ExportImportProductAttributes)
                        {
                            ...
                            var bigPicture = managerProductAttribute.GetProperty("BigPicture").StringValue;
                            var smallPicture = managerProductAttribute.GetProperty("SmallPicture").StringValue;
                            //
                            ...
                            //rel
                            //if pav is null try checking by skuCode
                            if (pav == null)
                            {
