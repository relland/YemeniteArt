...
namespace Nop.Services.ExportImport
{
    ...
    public partial interface IImportManager
    {
        ...
        /// </summary>
        /// <param name="stream">Stream</param>
        void REL_ImportProductsFromXlsx(Stream stream, string basePath);
        void REL_ImportProductsFromXlsx_Test(Stream stream, string basePath, out string errorMessage);
        /// <summary>
