    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new MediaSettings
            {
                ...
                CategoryThumbPictureSize = 174,//rel
                //rel
                CategoryThumbPictureBSize = 174,
            ...
            //rel
            settingService.SaveSetting(new PriceCalculationSettings
            {
                RetailSilverFactor = 8.5m,
                WholesaleSilverFactor = 4.1m,
                RetailGoldPlatedFactor = 1.15m,
                WholesaleGoldPlatedFactor = 1.15m,
                RetailSolidGold14KFactor = 125m,
                WholesaleSolidGold14KFactor = 60m,
                RetailSolidGold18KFactor = 160m,
                WholesaleSolidGold18KFactor = 77m
            });
            //end rel
        }
        ...
        protected virtual void InstallCategories()
        {
            ...
            var handmadeJewelry = new Category
            {
            ...
            allCategories.Add(handmadeJewelry);
            _categoryRepository.Insert(handmadeJewelry);

            var judaica = new Category
            {
                Name = "Judaica",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(judaica);
            _categoryRepository.Insert(judaica);


            var goldOverlay = new Category
            {
                Name = "Gold Overlay",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(goldOverlay);
            _categoryRepository.Insert(goldOverlay);
            ...
            var rings = new Category
            {
                ...
                AllowCustomersToSelectPageSize = true,
                PageSizeOptions = "8, 4, 12",
                ParentCategoryId = handmadeJewelry.Id,
            ...
            allCategories.Add(rings);
            _categoryRepository.Insert(rings);
            ...
            allCategories.Add(earrings);
            _categoryRepository.Insert(earrings);
            ...
            allCategories.Add(bracelets);
            _categoryRepository.Insert(bracelets);
            ...
            allCategories.Add(necklaces);
            _categoryRepository.Insert(necklaces);
            var pins = new Category
            {
                Name = "Pins & Pendants",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(pins);
            _categoryRepository.Insert(pins);
            var silverChains = new Category
            {
                Name = "Silver Chains",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(silverChains);
            _categoryRepository.Insert(silverChains);
            var romanGlass = new Category
            {
                Name = "Roman Glass",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(romanGlass);
            _categoryRepository.Insert(romanGlass);
            var mensJewelry = new Category
            {
                Name = "Men's Jewelry",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(mensJewelry);
            _categoryRepository.Insert(mensJewelry);

            var newItems = new Category
            {
                Name = "New Items",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(newItems);
            _categoryRepository.Insert(newItems);

            var candlesticks = new Category
            {
                Name = "Candlesticks",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(candlesticks);
            _categoryRepository.Insert(candlesticks);
            var menorahs = new Category
            {
                Name = "Menorahs",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(menorahs);
            _categoryRepository.Insert(menorahs);
            var mezuzas = new Category
            {
                Name = "Mezuzas",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(mezuzas);
            _categoryRepository.Insert(mezuzas);
            var dreidels = new Category
            {
                Name = "Dreidels",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(dreidels);
            _categoryRepository.Insert(dreidels);
            var pointers = new Category
            {
                Name = "Pointers",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(pointers);
            _categoryRepository.Insert(pointers);
            var talitClips = new Category
            {
                Name = "Talit Clips",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(talitClips);
            _categoryRepository.Insert(talitClips);
            var tzedakah = new Category
            {
                Name = "Tzedakah & Spice Boxes",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
                AllowCustomersToSelectPageSize = true,
                PageSizeOptions = "8, 4, 12",
            ...
            allCategories.Add(tzedakah);
            _categoryRepository.Insert(tzedakah);
            var kiddushCups = new Category
            {
                Name = "Kiddush Cups",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(kiddushCups);
            _categoryRepository.Insert(kiddushCups);
            var newItems2 = new Category
            {
                Name = "New Items",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(newItems2);
            _categoryRepository.Insert(newItems2);

            //
            var rings2 = new Category
            {
                Name = "Rings",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
                AllowCustomersToSelectPageSize = true,
                PageSizeOptions = "8, 4, 12",
                ParentCategoryId = goldOverlay.Id,
                //PictureId = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "category_notebooks.jpg"), "image/pjpeg", pictureService.GetPictureSeName("Notebooks"), true).Id,
                IncludeInTopMenu = false,
                Published = true,
                DisplayOrder = 2,
            ...
            allCategories.Add(rings2);
            _categoryRepository.Insert(rings2);
            var earrings2 = new Category
            {
                Name = "Earrings",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(earrings2);
            _categoryRepository.Insert(earrings2);
            var bracelets2 = new Category
            {
                Name = "Bracelets",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(bracelets2);
            _categoryRepository.Insert(bracelets2);
            var necklaces2 = new Category
            {
                Name = "Necklaces",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(necklaces2);
            _categoryRepository.Insert(necklaces2);
            var pendants2 = new Category
            {
                Name = "Pendants",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(pendants2);
            _categoryRepository.Insert(pendants2);
            var cufflinks2 = new Category
            {
                Name = "Cufflinks",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(cufflinks2);
            _categoryRepository.Insert(cufflinks2);
            var romanGlass2 = new Category
            {
                Name = "Roman Glass",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(romanGlass2);
            _categoryRepository.Insert(romanGlass2);
            var newItems3 = new Category
            {
                Name = "New Items",
                CategoryTemplateId = categoryTemplateInGridAndLines.Id,
                PageSize = 4,
            ...
            allCategories.Add(newItems3);
            _categoryRepository.Insert(newItems3);
