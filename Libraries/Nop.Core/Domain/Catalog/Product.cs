...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        //rel
        /// <summary>
        /// Gets or sets a value indicating whether this is a stone product (that's been added to attributes)
        /// </summary>
        public bool IsStoneProduct { get; set; }
        /// <summary>
        /// Gets or sets a value indicating the stone name id
        /// </summary>
        public string StoneNameId { get; set; }
        /// <summary>
        /// Gets or sets a value indicating if to Display relevent Silver GF 14K 18K links
        /// </summary>
        public bool DisplaySilverGF14K18K { get; set; }
        /// <summary>
        /// Gets or sets a value of the class - how to display the stones on GUI - square, round, oval...
        /// </summary>
        public string CssStoneClass { get; set; }
        ///// <summary>
        ///// Gets or sets a value of SilverGF14K18KSKUs divided with ;
        ///// </summary>
        //public string SilverGF14K18KSKUs { get; set; }
        //end rel
